...
for epoch in np.arange(0, args["epochs"]):
    ...
    for (batchX, batchY) in next_batch(X, y, args["batch_size"]):
        ...
        # in the update stage.all we nees to do is "nudge"the weight matrix in the negative direction of the gradient(hence the term "gradient descent"by taking a small step toward a set of "more optimal" parameters
