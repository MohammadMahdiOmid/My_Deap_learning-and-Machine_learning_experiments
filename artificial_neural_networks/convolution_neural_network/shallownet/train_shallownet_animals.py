...
from artificial_neural_networks.convolution_neural_network.shallownet.shallownet import ShallowNet
...
# training model
print('[INFO] TRAINING ...')
model_history = model.fit(train_x, train_y, batch_size=batch_size, epochs=epochs, validation_data=(test_x, test_y),
                          verbose=1)
